...
#API to the buffer board
    ...
    def select_page(self, page):
        "Set the active iSensor-SPI-Buffer page. Pages less than 253 will select IMU"

        #write page value to addr 0
    ...
    def start_stream(self):
        ...
        #start stream receive thread (starts streams)
...
#private helper functions (not actually private)
...
class StreamWork(Thread):
    ...
    def run(self):
        ...
        #flush firmware buffer contents
